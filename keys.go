...
func DefaultKeyMap() KeyMap {
	return KeyMap{
		...
		OpenInOther:     Shortcut{Key: "alt+o", DisplayKey: "o", Modifier: "alt", Action: "Open Other", Cmd: "open_in_other"},
		SyncPanes:       Shortcut{Key: "alt+i", DisplayKey: "i", Modifier: "alt", Action: "Sync", Cmd: "sync_panes"},
	}
}
